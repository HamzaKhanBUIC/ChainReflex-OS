...
class InventoryImpact(BaseModel):
    ...
    risk_assessment: str = Field(..., description="Qualitative summary of the risk")
...
class ComplianceReport(BaseModel):
    is_approved: bool = Field(..., description="True if the email is safe and professional, False otherwise.")
    flag_reason: str = Field(..., description="Explanation of why it was flagged, or 'Passed' if approved.")